...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: 'Over Tekniq Hulp', children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://help.tekniq.nl/hulp-op-afstand');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://help.tekniq.nl');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
              ...
              InkWell(
                  onTap: () {
                    launchUrlString(
                        'https://github.com/TimTekniq/rustdesk/tree/tekniq-hulp-1.4.9');
                  },
                  child: const Text(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Tekniq-aanpassingen © ${DateTime.now().toString().substring(0, 4)} Tekniq\nGebaseerd op RustDesk © Purslane Tech Pte. Ltd.\n$license',
