...
$replacements = [ordered]@{
    'RwLock::new("com.carriez".to_owned())' = 'RwLock::new("nl.tekniq".to_owned())'
    ...
    'pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk".to_owned());' = 'pub static ref APP_NAME: RwLock<String> = RwLock::new("Tekniq Hulp".to_owned());'
...
Write-Host 'Tekniq Hulp branding and self-hosted server settings applied.'
